$(function () {
    ...
    function syncDrawingData(data) {
        document.querySelector('#text_area').value = data.textarea_value
        if (data.textarea_color == 'white') {
            document.querySelector('#text_area').style.backgroundColor = 'white'
        }
        if (data.textarea_color == 'red') {
            document.querySelector('#text_area').style.backgroundColor = 'red'
        } 
        if (data.textarea_color == 'yellow') {
            document.querySelector('#text_area').style.backgroundColor = 'yellow'
        }
        if (data.textarea_color == 'green') {
            document.querySelector('#text_area').style.backgroundColor = 'green'
        }
    }
    ...
    function select_color() {
        background_color = document.querySelector('#select').value
